    ...
    <div class="row">
      ...
      <div class="col-md-3 col-sm-6">
        <div class="about-us-col">
          ...
          <a href="#" data-toggle="modal" data-target="#donateModal" class="btn btn-secondary">
            Donate
          </a>
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-md-6">
        <div class="reasons-col animate-onscroll fadeIn">
          <img src="./assets/images/together_1.jpg" alt="" />
      ...
      <div class="col-md-6">
        <div class="reasons-col animate-onscroll fadeIn">
          <img src="./assets/images/love_care.jpg" alt="" />
...
<div class="section-home our-causes animate-onscroll fadeIn" id="programs">
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-3 col-sm-6">
        <div class="cause">
          <img src="./assets/images/health_nutrition.jpg" alt="" class="cause-img" />
      ...
      <div class="col-md-3 col-sm-6">
        <div class="cause">
          <img src="./assets/images/educatiion_1.jpg" alt="" class="cause-img" />
      ...
      <div class="col-md-3 col-sm-6">
        <div class="cause">
          <img src="./assets/images/rights_4.jpg" alt="" class="cause-img" />
      ...
      <div class="col-md-3 col-sm-6">
        <div class="cause">
          <img src="./assets/images/rights.jpg" alt="" class="cause-img" />
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-donation">
          ...
          <div class="row">
            <div class="form-group col-md-12">
              <button type="submit" class="btn btn-secondary pull-right" name="donateNow">
                DONATE NOW
              </button>
            </div>
          </div>
